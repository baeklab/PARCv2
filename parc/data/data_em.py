...
class DataEnergeticMaterials(BaseData):
    ...
    def clip_raw_data(self, dataset_range, dir_dataset, n_seq=2, n_state=3, mode_diff = True, tgt_sz = (512,1024), dim_reduce = 4):
        ...
        It takes single void simulations in their individual numpy files with following notes: 
            1) each simulation have different number of time steps
        ...
        return X_dataset, U_dataset, names
